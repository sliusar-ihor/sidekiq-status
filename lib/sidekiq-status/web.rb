  ...
  module Web
    ...
    def self.registered(app)
      ...
      app.get '/statuses' do
        ...
        jids = Sidekiq::WorkSet.new.map do |process_id, thread_id, work|
          payload = Sidekiq::MAJOR >= 8 ? work.payload : work['payload']
          JSON.parse(payload)['jid']
        end
      ...
      app.get '/statuses/:jid' do
        jid = Sidekiq::MAJOR >= 8 ? route_params('jid') : params['jid']
        job = Sidekiq::Status::get_all jid
